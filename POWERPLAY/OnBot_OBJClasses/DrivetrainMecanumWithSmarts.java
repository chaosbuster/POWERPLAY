...
public class DrivetrainMecanumWithSmarts extends BlocksOpModeCompanion {
    ...
    static private double[] powerLevel = {0.20, 0.50, 0.70};    
    ...
    static final int maxRunTime = 5000;   // Max run time for a state is 4 seconds.
  ...
  public static void runDrivetrainIteration() {
     ...
     */
    static public void initDriveTrainWithSmarts(String driveLeftFrontName, String driveLeftBackName, String driveRightFrontName, String driveRightBackName) {
